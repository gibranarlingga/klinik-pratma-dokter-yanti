...
<body id="page-top">
  ...
  <div id="wrapper">
    <!-- Sidebar -->
    <ul class="navbar-nav bg-white sidebar accordion" id="accordionSidebar" style="color:black;">

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard')}}" style="color:black;">
        <div class="sidebar-brand-icon {{(get_setting('gambarbool') !== 1) ? 'rotate-n-20' :''}}">
          <img class src="{{URL::asset('img/avatars/dy.png')}}" width=190px>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Pilih "Logout" Jika anda yakin ingin mengakhiri sesi anda.</div>
