@extends('master')
 @section('judul_halaman')
    ...
    @section('deskripsi_halaman')
        Lakukan pengeditan profil dengan mengisi formulir berikut.
    @endsection
@section('konten')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="profesi" type="text" class="form-control @error('profesi') is-invalid @enderror" name="profesi" required>
                                    ...
                                    <option value="PEmilik Klinik" {{$user->profesi == "Pemilik Klinik" ? 'selected':''}}>Pemilik Apotek</option>
                                    <option value="apoteker" {{$user->profesi == "Apotek" ? 'selected':''}}>Apoteker</option>
