                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block bg-login-image">
                            <img class src="{{URL::asset('img/avatars/iconlog.png')}}" width=400px style="margin-top: 100px; margin-left: 60px;">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Klinik Pratama Dokter Yanti !</h1>
                                </div>
                                ...
                                <form class="user" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-12">
                                            ...
                                            <a class="btn btn-user btn-block" href="{{ route('password.request') }}">
